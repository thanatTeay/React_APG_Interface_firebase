    ...
    /*useEffect(() => {
        if (isRunning) {
            ...
            const id = window.setInterval(() => {
                 firebaseConfig.auth().createUserWithEmailAndPassword("B" + idPilot + "@icelab.com", "icelab1234").then(cred => {
                     cred.user.updateProfile({
                         displayName: "User" + idPilot
                ...
                firebaseConfig.auth().signInWithEmailAndPassword("B" + idPilot + "@icelab.com", "icelab1234").then((cred) => {
                    cred.user.updateProfile({
                        displayName: "UserB" + idPilot
